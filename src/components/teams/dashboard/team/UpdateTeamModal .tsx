...
const UpdateTeamModal: React.FC<UpdateTeamModalProps> = ({ team, onClose, onConfirm }) => {
  const dispatch = useDispatch<AppDispatch>();
    ...
    const [members, setMembers] = useState<string[]>(team.members.map((m) => m.email));
    ...
    const handleUpdateTeamInternal = async () => {
        ...
        try {
            await dispatch(editTeam({ id: team._id, data: updateData })).unwrap();
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                ...
                                <div className="mt-6 flex justify-end gap-3">
                                    ...
                                    <button
                                        onClick={handleUpdateTeamInternal}
